...
export const BUILDS: readonly Build[] = [
  ...
  },
  {
    ...
    summary:
      "A single workspace for the work an investor-relations, PR, and capital-markets team does: earnings prep, peer and investor intelligence, crisis response, governance and activism monitoring, IPO readiness, and on-voice drafting, all grounded in live market data. Twenty-five modules sit on a Postgres brain fed by SEC EDGAR, FMP, FRED, Polygon, and other sources, with an AI layer on Anthropic Claude doing streaming generation, tool use, and retrieval over filings. I designed and shipped it as an in-house AI platform for financial-communications teams, prototyping most of it solo on Claude Code. This is a faithful recreation on sample data: every company, figure, holder, and filing in the demo is fictional.",
    highlights: [
