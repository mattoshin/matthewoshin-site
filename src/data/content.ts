...
export const BUCKETS: readonly Bucket[] = [
  ...
  },
  {
    ...
    href: "/portfolio",
    teaser:
      "The products I build and run now: two GTM engineering platforms, one for fintech banking and one for AI property management, the Options-Implied Distribution Terminal, Galactic Signals, Observly, BriefBridge, mTrain, and the Dog House band site. Each card says what it is and what it does, and opens a live demo you can click through yourself.",
    nav: true,
...
export const BUILDS: readonly Build[] = [
  ...
  },
  {
    ...
    demoHref: "/app/financial-comms",
    summary:
      "A single workspace for the work an investor-relations, PR, and capital-markets team does: earnings prep, peer and investor intelligence, crisis response, governance and activism monitoring, IPO readiness, and on-voice drafting, all grounded in live market data. Eight core workspaces, each going deep rather than spreading thin, sit on a Postgres brain fed by SEC EDGAR, FMP, FRED, Polygon, and other sources, with an AI layer on Anthropic Claude doing streaming generation, tool use, and retrieval over filings. I designed and shipped it as an in-house AI platform for financial-communications teams, prototyping most of it solo on Claude Code. This is a faithful recreation on sample data: every company, figure, holder, and filing in the demo is fictional.",
    highlights: [
...
export const PORTFOLIO = {
  heading: "Portfolio.",
  blurb:
    "Everything I've built, past and present: the AI products I'm shipping now, the web and client work I've delivered, and the ventures I founded and ran. Open any of them for the full case study.",
} as const;
...
export const INTERESTS: readonly Interest[] = [
  ...
  },
  {
    ...
    detail:
      "I like to compete, and it shows up in how I build: running several ventures at once in college, and treating every event and product as something worth doing properly.",
  },
  {
