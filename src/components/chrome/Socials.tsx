...
function SocialLink({
  ...
  return (
    <a
      ...
      className="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-deep-body/70 text-ink-body backdrop-blur-md transition-colors hover:border-bio-cyan/60 hover:text-bio-cyan"
    >
      {children}
    </a>
  );
