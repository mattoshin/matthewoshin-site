...
const ROLE_CONTEXT: Record<string, RoleContext> = {
  brachyclip: {
    overview:
      "BrachyClip is a cancer medical device company affiliated with Brown University and Rhode Island Hospital, building a clip-based brachytherapy seed delivery system for minimally invasive cancer surgery. I came in as Chief AI Officer and Director of Marketing to build the brand, go-to-market, and investor narrative from zero, for a device that hasn't yet cleared the FDA.",
    storyParagraphs: [
  ...
  qult: {
    overview:
      "Qult.ai was an early-stage AI startup in the healthcare-career space. As AI PM, I led a four-person engineering team, owned product direction, and was responsible for getting the product off the ground operationally, in 2023.",
    lessons: [
