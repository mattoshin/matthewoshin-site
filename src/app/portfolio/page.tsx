 ...
 * "projects" zone with /entrepreneurship). The two products with interactive
 * in-site demos (Mocean + Galactic Signals) lead as featured cards with a bright
 * "View Demo" button; the rest of the current builds follow. Cards link to the
 * full case studies. The navLabel override keeps the eyebrow reading "Portfolio".
 */
