...
What he builds now: Riptide Research (formerly called Sigma), an options-implied distribution equity-research terminal, and Galactic Signals, a trading-signals platform. His Portfolio page on this site also has live clickable demos of other builds, including Sonar Media, Observly, BriefBridge, and mTrain. In total he has shipped 20+ products end to end.
