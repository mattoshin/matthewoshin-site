...
What he builds now: GTM Engineering, a go-to-market platform for SDR and AE teams with an agent studio deployable to your own infrastructure; the Options-Implied Distribution Terminal, an equity-research terminal that prices where his view disagrees with the options market; and Galactic Signals, a trading-signals platform. His Portfolio page on this site also has live clickable demos of other builds, including Observly, BriefBridge, and mTrain. His web and client work includes Dog House (doghouseband.matthewoshin.com), a photo-led site plus self-serve CMS he designed and built end to end for a NYC rock band; its case study is on the Portfolio page. In total he has shipped 20+ products end to end.
